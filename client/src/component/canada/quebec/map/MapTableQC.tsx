...
export default function MapTable(props: MapTableProps) {
    const serverURL = `/election/quebec/${props.year}/circonscription/`
    const [circonscription, setCirco] = useState<ICirconscription>()

    useEffect(() => {
        const numeroCO = props.geo.properties.CO_CEP
